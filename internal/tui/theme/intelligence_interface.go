...
// IntelligenceInterfaceTheme implements the Theme interface with Intelligence Interface brand colors.
// It provides both dark and light variants.
type IntelligenceInterfaceTheme struct {
	BaseTheme
}

// NewIntelligenceInterfaceTheme creates a new instance of the Intelligence Interface theme.
func NewIntelligenceInterfaceTheme() *IntelligenceInterfaceTheme {
	// Intelligence Interface color palette
	// Dark mode colors
	...
	theme := &IntelligenceInterfaceTheme{}
	...
	theme.CaronexPrimaryColor = lipgloss.AdaptiveColor{
		Dark:  "#b19cd9", // Light purple/violet
		Light: "#7b5bb6", // Darker purple for light mode
	}
	theme.CaronexSecondaryColor = lipgloss.AdaptiveColor{
		Dark:  "#daa520", // Goldenrod
		Light: "#d68c27", // Darker gold for light mode
	}
	theme.CaronexAccentColor = lipgloss.AdaptiveColor{
		Dark:  "#ff6b9d", // Pink accent
		Light: "#e91e63", // Material pink
	}
	theme.CaronexBorderColor = lipgloss.AdaptiveColor{
		Dark:  "#9d7cd8", // Purple border
		Light: "#7b5bb6", // Purple border for light mode
	}
	theme.CaronexBackgroundColor = lipgloss.AdaptiveColor{
		Dark:  "#2a1f3d", // Dark purple background
...
func init() {
	// Register the Intelligence Interface theme with the theme manager
	RegisterTheme("intelligence-interface", NewIntelligenceInterfaceTheme())
}
