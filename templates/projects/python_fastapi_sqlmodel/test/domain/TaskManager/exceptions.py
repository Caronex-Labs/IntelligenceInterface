""" domain exceptions - Generated from Enhanced Co-located Template.
This module contains domain-specific exceptions for the TaskManager domain following
...
- exceptions.py.j2: This enhanced Jinja2 template with best practices
...
- Macros for repeated exception class generation
- Proper variable scoping with Jinja2 set tags
- Filters for text transformation (|upper, |title)
...
"""Base exception class for TaskManager domain.
...
logger = logging.getLogger(f"TaskManager.exceptions")
log_data = {
...
"""Exception raised when a TaskManager entity is not found."""
def __init__(
self,
entity_type: str,
entity_id: Optional[str] = None,
...
"""Exception raised when TaskManager validation fails."""
def __init__(
self,
field_name: str,
field_value: Any,
...
context_data: Additional context data
"""
error_code = f"_VALIDATION_ERROR"
...
"""Exception raised when TaskManager business rules are violated."""
def __init__(
self,
rule_name: str,
...
context_data: Additional context data
"""
error_code = f"_BUSINESS_RULE_ERROR"
...
"""Exception raised when TaskManager authorization fails."""
def __init__(
self,
user_id: str,
action: str,
...
context_data: Additional context data
"""
error_code = f"_AUTHORIZATION_ERROR"
...
"""Exception raised when TaskManager integration fails."""
def __init__(
self,
...
context_data: Additional context data
"""
error_code = f"_INTEGRATION_ERROR"
...
"""Exception raised when TaskManager system errors occur."""
def __init__(
self,
...
context_data: Additional context data
Returns:
NotFoundError: Configured not found exception
"""
...
context_data: Additional context data
Returns:
ValidationError: Configured validation exception
"""
...
context_data: Additional context data
Returns:
BusinessRuleError: Configured business rule exception
"""
...
async def domain_exception_handler(request, exc: BaseException):
...
def validate_exception_context(context: ExceptionContext) -> List[str]:
